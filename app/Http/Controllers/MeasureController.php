...
class MeasureController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreMeasure $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreMeasure $request, Measure $measure)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Request $request, Measure $measure)
    {
        $measure->delete();
