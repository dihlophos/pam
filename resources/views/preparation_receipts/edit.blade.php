...
<form action="/subdivision/{{$subdivision->id}}/preparation_receipt/{{$preparationReceipt->id}}" class="well" id="PreparationReceiptEditForm" method="post" accept-charset="utf-8">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <input name="prod_date" type="date" class="form-control" id="PreparationReceiptExpireDate" value="{{ $preparationReceipt->prod_date }}">
        </div>
        <div class="form-group">
            <label for="PreparationReceiptPackDate">Дата расфасовки</label>
            <input name="pack_date" type="date" class="form-control" id="PreparationReceiptExpireDate" value="{{ $preparationReceipt->pack_date }}">
        </div>
        <div class="form-group">
